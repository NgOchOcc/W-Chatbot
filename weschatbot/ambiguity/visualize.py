...
class PerQuestionVisualizer:
    ...
    def _plot_kmeans_combined(self, fig, vectors, labels, scores, qid, q_df):
        ...
        ax2.set_xticklabels([f'C{l}' for l in unique_labels])
    ...
    def _plot_dbscan_combined(self, fig, vectors, labels, scores, qid):
        ...
        label_names = ['Noise' if l == -1 else f'C{l}' for l in unique_labels]
        ...
        data = [scores[labels == l] for l in unique_labels_list]
        names = ['Noise' if l == -1 else f'C{l}' for l in unique_labels_list]
